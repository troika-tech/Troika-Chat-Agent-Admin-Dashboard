...
const FONT_OPTIONS = [
  ...
  { name: "Poppins (Geometric Sans-serif)", value: "Poppins" },
  { name: "Roboto (Classic Sans-serif)", value: "Roboto" },
  { name: "Lato (Friendly Sans-serif)", value: "Lato" },
  { name: "Montserrat (Stylish Sans-serif)", value: "Montserrat" },
  { name: "Open Sans (Readable Sans-serif)", value: "Open Sans" },
  ...
  { name: "Source Code Pro (Coding Mono)", value: "Source Code Pro" },
  { name: "Inconsolata (Clean Mono)", value: "Inconsolata" },
  { name: "Pacifico (Script)", value: "Pacifico" },
  { name: "Lobster (Bold Script)", value: "Lobster" },
  { name: "Caveat (Handwritten)", value: "Caveat" },
  { name: "Arial (System)", value: "Arial" },
  { name: "Times New Roman (System)", value: "Times New Roman" },
];
...
const ChatbotCustomizationPage = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <div className="w-3/5 p-6 space-y-8 bg-white overflow-y-auto">
        <h1 className="text-2xl font-bold text-gray-800">Chatbot Customization</h1>

        {/* Section: Header Background Customization */}
        <section className="space-y-3 p-4 bg-gray-100 rounded-lg">
          <h2 className="text-xl font-semibold text-gray-700">Header Background</h2>
            ...
            <>
              ...
              <div className="pt-4">
                ...
                <input
                  ...
                  value={headerColor.startsWith("linear-gradient") ? headerColor : ""}
                  onChange={(e) => setHeaderColor(e.target.value)}
                />
              </div>
            </>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-700">Button Customization</h2>
          <div className="p-4 bg-gray-100 rounded-lg space-y-3">
            <label className="text-md font-semibold text-gray-700">
              Send/Mic Buttons Background
            </label>
            <div className="flex items-center space-x-4">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  type="radio"
                  value="color"
                  checked={buttonStyleType === "color"}
                  onChange={() => setButtonStyleType("color")}
                  className="form-radio h-4 w-4 text-blue-600"
                />
                <span>Solid Color</span>
              </label>
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  type="radio"
                  value="gradient"
                  checked={buttonStyleType === "gradient"}
                  onChange={() => {
                    setButtonStyleType("gradient");
            ...
            {buttonStyleType === "color" ? (
              <div>
                <input
                  type="color"
                  value={buttonColor.startsWith("#") ? buttonColor : "#3b8276"}
        ...
        {/* Section: Bot Content Customization */}
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-700">Bot Content</h2>
          <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-600">Bot Subtitle</label>
            <input
              type="text"
              value={botSubtitle}
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-600">Welcome Message</label>
            <input
              type="text"
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-700">UI Suggestions (Max 5)</h2>
          {suggestions.map((suggestion, index) => (
            ...
            >
              ...
              />
              <div className="pt-2">
                <label className="text-sm font-medium text-gray-600">Icon Background</label>
                ...
                {suggestion.bgType === "color" ? (
                  <div className="mt-2">
                    <input
                      type="color"
                      value={suggestion.bg.startsWith("#") ? suggestion.bg : "#cccccc"}
                      onChange={(e) =>
      ...
      <div className="w-3x/5 p-8 border-l border-gray-200 bg-gradient-to-r from-pink-500 via-purple-400 to-pink-300 overflow-y-auto">
