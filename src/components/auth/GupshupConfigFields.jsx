...
const GupshupConfigFields = ({ config, setConfig, showPassword, setShowPassword }) => {
  return (
    <>
      <div>
        ...
        <div className="relative">
          <input
            type={showPassword.gupshup_api_key ? "text" : "password"}
          ...
          <button
            ...
            onClick={() =>
              setShowPassword({
                ...showPassword,
                gupshup_api_key: !showPassword.gupshup_api_key,
              })
            }
            className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600"
          >
            {showPassword.gupshup_api_key ? (
              <EyeOff size={18} />
            ) : (
              <Eye size={18} />
            )}
      ...
      <div>
        ...
        <input
          type="text"
          value={config.provider_config?.app_name || ""}
          onChange={(e) =>
            setConfig({
              ...config,
              provider_config: {
...
export default GupshupConfigFields;
