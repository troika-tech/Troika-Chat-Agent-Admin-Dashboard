...
const Dialog360ConfigFields = ({ config, setConfig, showPassword, setShowPassword }) => {
  return (
    <>
      <div>
        ...
        <div className="relative">
          <input
            type={showPassword.dialog360_api_key ? "text" : "password"}
            ...
            placeholder="Enter 360dialog API key"
          ...
          <button
            ...
            onClick={() =>
              setShowPassword({
                ...showPassword,
                dialog360_api_key: !showPassword.dialog360_api_key,
              })
            }
            className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600"
          >
            {showPassword.dialog360_api_key ? (
              <EyeOff size={18} />
            ) : (
              <Eye size={18} />
            )}
      ...
      <div>
        ...
        <input
          type="text"
          value={config.provider_config?.instance_id || ""}
          onChange={(e) =>
            setConfig({
              ...config,
              provider_config: {
          ...
          placeholder="Enter 360dialog instance ID"
...
export default Dialog360ConfigFields;
